...
public class CurrencyMB extends baseManagedBeanController<Currency> implements Serializable
{
	...
	@Autowired
	private CurrencyUCService currencyService;




	//base Object, relations Lists (1-* objects)//CurrencyMB
	...
	protected void ResetBaseObject()
	{
		...
		// refresh Lists
		baseEntityList = currencyService.FindAll("id", JPAOp.Asc);
	}
	...
	public void AddEdit() throws gException
	{
		...
		{
			if (isedit)
				currencyService.Edit(baseEntity);
			else
				result = currencyService.Add(baseEntity);
	...
	//UC: Remove
	public void Remove(Currency baseEntity)
	{
		try
		{
			currencyService.Remove(baseEntity);
			ResetBaseObject();
