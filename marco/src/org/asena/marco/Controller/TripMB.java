...
public class TripMB extends baseManagedBeanController<Trip> implements Serializable
{
	...
	@Autowired
	private TripUCService TripService;
	...
	protected void ResetBaseObject()
	{
		...
		// refresh Lists
		baseEntityList = TripService.FindAll("id", JPAOp.Asc);
	}
	...
	public void AddEdit() throws gException
	{
		...
		{
			if (isedit)
				TripService.Edit(baseEntity);
			else
				result = TripService.Add(baseEntity);
	...
	//UC: Remove
	public void Remove(Trip baseEntity)
	{
		try
		{
			TripService.Remove(baseEntity);
			ResetBaseObject();
