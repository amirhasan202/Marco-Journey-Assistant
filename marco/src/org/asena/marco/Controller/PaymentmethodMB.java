...
@ManagedBean(name = "PaymentmethodMB")
@ViewScoped

public class PaymentmethodMB extends baseManagedBeanController<Paymentmethod> implements Serializable
{
	...
	@Autowired
	private PaymentmethodUCService PaymentmethodService;
	...
	protected void ResetBaseObject()
	{
		...
		// refresh Lists
		baseEntityList = PaymentmethodService.FindAll("id", JPAOp.Asc);
	}
	...
	public void AddEdit() throws gException
	{
		...
		{
			if (isedit)
				PaymentmethodService.Edit(baseEntity);
			else
				result = PaymentmethodService.Add(baseEntity);
	...
	//UC: Remove
	public void Remove(Paymentmethod baseEntity)
	{
		try
		{
			PaymentmethodService.Remove(baseEntity);
			ResetBaseObject();
