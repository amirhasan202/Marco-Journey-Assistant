...
@ManagedBean(name = "ReturnruleMB")
@ViewScoped

public class ReturnruleMB extends baseManagedBeanController<Returnrule> implements Serializable
{
	...
	@Autowired
	private ReturnruleUCService ReturnruleService;
	...
	protected void ResetBaseObject()
	{
		...
		// refresh Lists
		baseEntityList = ReturnruleService.FindAll("id", JPAOp.Asc);
	}
	...
	public void AddEdit() throws gException
	{
		...
		{
			if (isedit)
				ReturnruleService.Edit(baseEntity);
			else
				result = ReturnruleService.Add(baseEntity);
	...
	//UC: Remove
	public void Remove(Returnrule baseEntity)
	{
		try
		{
			ReturnruleService.Remove(baseEntity);
			ResetBaseObject();
